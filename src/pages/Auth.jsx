...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-white border-black flex flex-col md:flex-row">
      ...
      <div
        className="flex-1 p-4 md:p-8 flex flex-col items-center justify-center border" style={{ backgroundColor: '#FAFAFA' }}
        >
      
        <div className="w-full max-w-md space-y-6 md:space-y-8 border bg-white rounded p-6">
